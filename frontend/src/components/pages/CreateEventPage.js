                      ...
                      <SimpleGrid columns={{ base: 1, sm: 2 }} spacing={5}>
                        <FormControl id='name'>
                          ...
                          <InputGroup size='lg' borderColor='#E0E1E7'>
                            <Input type='text' variant='filled' placeholder='Enter title' value={title} onChange={(e) => setTitle(e.target.value)} />
                          </InputGroup>
                        </FormControl>
                        <FormControl flex='1' id='name'>
                          ...
                          <InputGroup size='lg' borderColor='#E0E1E7'>
                            ...
                            <Input type='text' variant='filled' placeholder='Enter location' value={location}
                        ...
                        <FormControl flex='1' id='name'>
                          ...
                          <InputGroup size='lg' borderColor='#E0E1E7'>
                            <Input type='number' variant='filled' placeholder='Enter free spots' value={maxParticipants}
                        ...
                        <FormControl flex='1' id='name'>
                          ...
                          <InputGroup size='lg' borderColor='#E0E1E7'>
                            <Input type='date' id='date' variant='filled' placeholder='Enter date' value={dateString}
                        ...
                        <FormControl flex='1' id='name'>
                          ...
                          <InputGroup size='lg' borderColor='#E0E1E7'>
                            <Input type='time' id='time' variant='filled' placeholder='Enter time' value={timeString}
                                   onChange={(e) => setTimeString(e.target.value)} />
                          </InputGroup>
                        </FormControl>
                        <FormControl id='description' gridColumn={{ base: '1 / -1', sm: 'span 2/span 2' }}>
